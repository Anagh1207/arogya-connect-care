      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Book Consultation</a></li>
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Health Plans</a></li>
            </ul>
          </div>

          <div>
            <h3 className="text-lg font-semibold mb-6">For Doctors</h3>
            <ul className="space-y-4">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Join Network</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Practice Management</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Billing Support</a></li>
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-gray-800 rounded-lg">
              ...
              <p className="text-white font-semibold">1-800-AROGYA</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Arogya Care. All rights reserved.
          </p>
